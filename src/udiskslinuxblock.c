                        ...
                        GVariant              *options)
{
  ...
  if (!udisks_daemon_util_check_authorization_sync (daemon,
                                                     ...
                                                     * disk image file.
                                                     *
                                                     * Do not translate $(drive.name), it's a placeholder and will
                                                     * be replaced by the name of the drive/device in question
                                                     */
                                                    N_("Authentication is required to open $(drive.name) for reading"),
                                                    invocation))
    goto out;
                           ...
                           GVariant              *options)
{
  ...
  if (!udisks_daemon_util_check_authorization_sync (daemon,
                                                     ...
                                                     * be replaced by the name of the drive/device in question
                                                     */
                                                    N_("Authentication is required to open $(drive.name) for benchmarking"),
                                                    invocation))
    goto out;
                    ...
                    GVariant              *options)
{
  ...
  if (!udisks_daemon_util_check_authorization_sync (daemon,
                                                     ...
                                                     * be replaced by the name of the drive/device in question
                                                     */
                                                    N_("Authentication is required to open $(drive.name)."),
                                                    invocation))
    goto out;
               ...
               GVariant              *options)
{
   ...
   * be replaced by the name of the drive/device in question
   */
  message = N_("Authentication is required to rescan $(drive.name)");
