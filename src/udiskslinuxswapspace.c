              ...
              GVariant               *options)
{
  ...
  if (!udisks_daemon_util_check_authorization_sync (daemon,
                                                     ...
                                                     */
                                                    N_("Authentication is required to activate swapspace on $(drive.name)"),
                                                    invocation))
    goto out;
             ...
             GVariant               *options)
{
  ...
  if (!udisks_daemon_util_check_authorization_sync (daemon,
                                                     ...
                                                     * will be replaced by the name of the drive/device in question
                                                     */
                                                    N_("Authentication is required to deactivate swapspace on $(drive.name)"),
                                                    invocation))
    goto out;
                  ...
                  GVariant               *options)
{
  ...
  if (!udisks_daemon_util_check_authorization_sync (daemon,
                                                     ...
                                                     * will be replaced by the name of the drive/device in question
                                                     */
                                                    N_("Authentication is required to set swapspace label on $(drive.name)"),
                                                    invocation))
    goto out;
                 ...
                 GVariant              *arg_options)
{
  ...
  if (!udisks_daemon_util_check_authorization_sync (daemon,
                                                     ...
                                                     * will be replaced by the name of the drive/device in question
                                                     */
                                                    N_("Authentication is required to set swapspace UUID on $(drive.name)"),
                                                    invocation))
    goto out;
