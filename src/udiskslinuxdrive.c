              ...
              GVariant              *options)
{
   ...
   */
  message = N_("Authentication is required to eject $(drive.name)");
                          ...
                          GVariant              *options)
{
   ...
   *
   * Do not translate $(drive.name), it's a placeholder and will be
   * replaced by the name of the drive/device in question
   */
  message = N_("Authentication is required to configure settings for $(drive.name)");
                  ...
                  GVariant              *options)
{
   ...
   * will be replaced by the name of the drive/device in question
   */
  message = N_("Authentication is required to power off $(drive.name)");
