  ...
  if (atasmart_blob != NULL)
    {
       ...
       * will be replaced by the name of the drive/device in question
       */
      message = N_("Authentication is required to set SMART data from a blob on $(drive.name)");
                             ...
                             GVariant              *options)
{
  ...
  if (!udisks_daemon_util_check_authorization_sync (daemon,
                                                     ...
                                                     * will be replaced by the name of the drive/device in question
                                                     */
                                                    N_("Authentication is required to abort a SMART self-test on $(drive.name)"),
                                                    invocation))
    goto out;
                             ...
                             GVariant              *options)
{
  ...
  if (!udisks_daemon_util_check_authorization_sync (daemon,
                                                     ...
                                                     * will be replaced by the name of the drive/device in question
                                                     */
                                                    N_("Authentication is required to start a SMART self-test on $(drive.name)"),
                                                    invocation))
    goto out;
                     ...
                     GVariant              *options)
{
   ...
   * will be replaced by the name of the drive/device in question
   */
  message = N_("Authentication is required to check power state for $(drive.name)");
                          ...
                          gboolean              do_wakeup)
{
   ...
   * will be replaced by the name of the drive/device in question
   */
  message = (do_wakeup) ? N_("Authentication is required to wake up $(drive.name) from standby mode") :
                          N_("Authentication is required to put $(drive.name) in standby mode");
                            ...
                            GVariant              *options)
{
   ...
   * will be replaced by the name of the drive/device in question
   */
  message = N_("Authentication is required to perform a secure erase of $(drive.name)");
  ...
  if (value)
    {
       ...
       * will be replaced by the name of the drive/device in question
       */
      message = N_("Authentication is required to enable SMART on $(drive.name)");
    }
  else
    {
      /* Translators: Shown in authentication dialog when the user
       ...
       * will be replaced by the name of the drive/device in question
       */
      message = N_("Authentication is required to disable SMART on $(drive.name)");
    }
